...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:SqlDataSource ID="IngredientsData" runat="server" ConnectionString="<%$ ConnectionStrings:FUBE %>" SelectCommand="SELECT [Name] FROM [Ingredients]"></asp:SqlDataSource>
