<%@ Page Title="Custom Tube" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomTube.aspx.cs" Inherits="Comp229_Fube.CustomTube" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div>
		...
		<asp:SqlDataSource ID="IngredientsData" runat="server" ConnectionString="<%$ ConnectionStrings:FUBE_Lucifer %>" SelectCommand="SELECT [Name] FROM [Ingredients]"></asp:SqlDataSource>
